...
public final class RandomStringGeneratorClient implements RandomStringGenerator {
  ...
  private final java.util.function.Function<? super org.reactivestreams.Publisher<io.netifi.proteus.demo.randomstring.RandomStringResponse>, ? extends org.reactivestreams.Publisher<io.netifi.proteus.demo.randomstring.RandomStringResponse>> generateString;
  ...
  public reactor.core.publisher.Flux<io.netifi.proteus.demo.randomstring.RandomStringResponse> generateString(io.netifi.proteus.demo.randomstring.RandomStringRequest message) {
    return generateString(message, io.netty.buffer.Unpooled.EMPTY_BUFFER);
  }

  @java.lang.Override
  @io.netifi.proteus.annotations.internal.ProteusGeneratedMethod(returnTypeClass = io.netifi.proteus.demo.randomstring.RandomStringResponse.class)
  public reactor.core.publisher.Flux<io.netifi.proteus.demo.randomstring.RandomStringResponse> generateString(io.netifi.proteus.demo.randomstring.RandomStringRequest message, io.netty.buffer.ByteBuf metadata) {
    ...
    }).map(deserializer(io.netifi.proteus.demo.randomstring.RandomStringResponse.parser())).transform(generateString);
  }
